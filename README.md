...
You can link this container with the a mongodb and redis container. 
For the mongodb server use **mongo** as alias and for the redis server use **redis** as alias.
